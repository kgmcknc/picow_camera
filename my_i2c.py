...
class i2c_class:
    ...
    def __init__(self, i2c_address=None, scl_pin=None, sda_pin=None, i2c_freq=None):
    ...
    def reg_write(self, reg, data):
        ...
        self.i2c_instance.writeto_mem(self.i2c_address, reg, msg)
    ...
    def reg_read(self, reg, num_bytes=1):
        ...
        data = self.i2c_instance.readfrom_mem(self.i2c_address, reg, num_bytes)
        return data
